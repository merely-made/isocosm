...
//!
//! `cargo run -p eponym-social --bin home`. S2's judgment surface: whether
...
use eponym_social::{Premise, settling};
...
fn main() {
    ...
    for answer in &answers {
        ...
        if let eponym_social::Verdict::Counteroffer(terms) = answer.verdict {
            println!(
    ...
    let names: Vec<(eponym_identity::SubjectId, String)> = society
        .companions()
