...
use eponym_client::frame_health::{FrameDecision, FrameHealth, PresentationPolicy, SharedFault};
use eponym_client::gpu::{self, Composer, SIZE, Tenant};
#[cfg(feature = "r1-proof")]
use eponym_client::gpu::{BrickAbi, DdaTenant};
...
impl HeadedValidationProbe {
    ...
    fn write_receipt(&self, validation: &eponym_client::frame_health::ValidationRecord) {
...
impl ApplicationHandler for RoomApp {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let attributes = Window::default_attributes()
            .with_title("Eponym S0: the room probe")
