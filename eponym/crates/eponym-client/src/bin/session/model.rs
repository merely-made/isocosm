...
//! P2: one played Eponym session as a Cambium document.
//!
...
//! `eponym_world::Session` held inside [`SceneModel`]. Because
...
use eponym_world::glyphs::GlyphReading;
use eponym_world::timed_action::Direction;
use eponym_world::{CombatRules, ItemId};
...
pub fn run() -> i32 {
    ...
    let options = HostOptions {
        title: "Eponym \u{b7} Session".into(),
