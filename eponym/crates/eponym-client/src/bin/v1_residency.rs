...
//!
//! Eponym pulls close, leading, and planning pages from one larger exact
...
impl ApplicationHandler for ResidencyApp {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let attributes = Window::default_attributes()
            .with_title("Eponym V1: continuous-zoom residency")
...
fn report(
    ...
    let receipt = Receipt {
        ...
        size: SIZE,
        frames: samples.len(),
        world_extent: eponym_client::residency::WORLD_EXTENT,
