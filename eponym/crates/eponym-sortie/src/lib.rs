...
//! they meet. The world and kinematics come from `eponym-client` and
//! mesocosm's near tier exactly as S0 consumes them; willingness comes from
//! `eponym-social` exactly as S1 and S2 built it; who the player is being
//! comes from `eponym-identity`'s control pointer. What is new here is
