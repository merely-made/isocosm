...
| [2026-09-25_eponym_overlay_plan.md](2026-09-25_eponym_overlay_plan.md) | **W5 plan, drafted 2026-09-25 at Mark's word ("Overlay plans to RPG"); E0 to E4 proposed, not opened; three of §6's seven decisions await Mark, decision 3 in part; ruling 231 placed this overlay side by side with the VTT's after Mesocosm's M3, and rulings 232 to 235 settled the handoff, the solver's home, the start in time and how a first life begins.** Eponym as a game overlay over the Isocosm sim, from the wing design record's §5.6 (rulings 185 to 187), ruling 60 (driving, with directing composed on it by opinion), ruling 130 (diegetic notes) and rulings 152 to 156, mirroring the Mesocosm overlay plan: the profile (domain, ensemble, mechanics, driving controls, the zoom camera, the moment), the played loop through a death and a succession, Eponym's side of the overlay contract as a module in `shared/isocosm-overlay`, where the contract opens the actuation of one body to this game alone, today's seventeen game intents, two world intents and four control intents mapped onto it, what of `eponym-world` and `eponym-social` Isocosm would absorb, and the forks still open: a death with no bonded companion, absorption and where driving is built, posing, and co-op in E4; ruled are the handoff and the solver's home (232, 233), the start in time (234), how a first life begins (235) and which overlay is W5's second (231). |
