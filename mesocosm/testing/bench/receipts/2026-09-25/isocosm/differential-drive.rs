...
//
// Built as the only binary of a scratch crate, once per core under test:
//
//   [package]  name = "drive", edition = "2024"
//   [workspace]
//   [dependencies]  isocosm = { path = "<a checkout>/shared/isocosm" }, serde_json = "1"
//   [[bin]]  name = "drive", path = "differential-drive.rs"
//
// with that checkout's Cargo.lock copied beside it, built `--release --offline`.
