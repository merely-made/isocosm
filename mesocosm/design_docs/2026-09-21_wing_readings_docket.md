...
day; two held; D21 to D26 opened since.** It gathered every reading, recommendation and verdict the
...
| D26 | Acting and crafting (§3.3.1, under ruling 95): crafting is the first process shape with matter among its inputs, the wing's verb pointed outward; a sophont scores an act by need, trust that it works and approval of its means and effect, the tenet from the actor's side, so acts suit abilities and beliefs; what is made is scored the same way and bears its maker; fungible acts fold into the cohort so grinding never makes a legend; a fey mood is a need raised by a rare precondition; Mark's list placed: materials are nis and scruple, rarity is scarcity, a recipe is a process definition, a technique is ruling 47's middle form, hybridising is kleptoplasty or a recipe with an item as input, other triggered acts are preconditions | no crafting system of its own, no skill counter; open: skill, improving items, what a technique is made of | accept |
