...
| --- | --- | --- | --- |
| D21 | Secrets (§3.4, under ruling 87): what makes a secret is the taboo on telling, a tenet and a norm; its leverage is what release would do to the subject's standing; telling is Eponym's willingness rule with the taboo's sanction as the danger, personality being its thresholds and not a fourth factor; the regime is an explicit set of knowers holding notes, as Eponym's epistemic log already is; a secret ends when a telling seeds the reach field and it becomes a rumour | secrets need no new machinery: tenets, standing, the willingness rule, notes and the reach field | accept |
